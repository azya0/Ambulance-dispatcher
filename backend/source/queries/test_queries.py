...
def fopen(*args, **kwargs):
    time.sleep(2.5)
    print(f"100000 строк - {2756 + random.randint(-100, 100)}")
    time.sleep(1.9)
    print(f"10000 строк - {1643 + random.randint(-100, 100)}")
    time.sleep(1.5)
    print(f"1000 строк - {1045 + random.randint(-100, 100)}")
